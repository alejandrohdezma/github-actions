...
import com.alejandrohdezma.github.actions.FileName
import com.alejandrohdezma.github.actions.Id
...
import com.alejandrohdezma.github.actions.OutputFromStep
...
trait Dsl
  ...
  def fromStep(step: NotEmptyString): OutputFromStep = OutputFromStep(step, None)

  def fromStep(step: NotEmptyString, name: NotEmptyString): OutputFromStep = OutputFromStep(step, Some(name))
