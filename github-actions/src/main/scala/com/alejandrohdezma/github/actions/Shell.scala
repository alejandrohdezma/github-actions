...
object Shell {
  ...
  case object Bash       extends Shell(NotEmptyString.unsafe("bash"))
  case object Pwsh       extends Shell(NotEmptyString.unsafe("pwsh"))
  case object Python     extends Shell(NotEmptyString.unsafe("python"))
  case object Sh         extends Shell(NotEmptyString.unsafe("sh"))
  case object Cmd        extends Shell(NotEmptyString.unsafe("cmd"))
  case object Powershell extends Shell(NotEmptyString.unsafe("powershell"))
