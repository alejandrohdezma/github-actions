...
/** Contains constructors and implicit instances for the [[Hour]] class. */
object Hour {

  /** Allows converting an [[Hour]] value into [[yaml.Yaml yaml]]. */
  /** Allows converting a [[Hour]] value into [[yaml.Yaml yaml]]. */
