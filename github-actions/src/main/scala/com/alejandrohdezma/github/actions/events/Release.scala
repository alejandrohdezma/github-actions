...
object Release {
  ...
  object Types {
    ...
    case object Published   extends Types(NotEmptyString.unsafe("published"))
    case object Unpublished extends Types(NotEmptyString.unsafe("unpublished"))
    ...
    case object Prereleased extends Types(NotEmptyString.unsafe("prereleased"))
    case object Released    extends Types(NotEmptyString.unsafe("released"))
