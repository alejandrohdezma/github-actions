...
import com.alejandrohdezma.github.actions.Ignore
import com.alejandrohdezma.github.actions.Matching
...
object WorkflowRun {
  ...
  object Types {
    ...
    case object Requested extends Types("requested")
    case object Completed extends Types("completed")
