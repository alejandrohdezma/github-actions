      ...
      workflow
          ...
          _.name("Process Scala Steward PRs: auto-approves, enable auto-merge...")
            ...
            .steps(
              ...
              uses("kentaro-m/auto-assign-action@v1.1.2")
                ...
                .withInput("repo-token", steps.installation_token.outputs.token),
        ...
        .job("test") {
          _.needs("scala-steward")
            .runsIf(always && is[PullRequest] && needs.`scala-steward`.outputs.changes_detected =!= "true")
            ...
            .steps(
              ...
              run("sbt ci-test")
                ...
                .runsIf(github.event.pull_request.head.repo.full_name === github.repository)
