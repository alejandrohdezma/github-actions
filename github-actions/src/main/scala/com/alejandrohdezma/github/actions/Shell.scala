...
sealed abstract class Shell(val value: String) extends StringEnumEntry

object Shell extends StringEnum[Shell] with StringCirceEnum[Shell] {
   ...
   */
  final case class Custom(shell: NonEmptyString) extends Shell(shell.value)
