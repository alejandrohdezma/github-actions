 ...
 */
final case class Service(name: NonEmptyString, container: Container)

object Service {

  implicit val ServiceEncoder: Encoder[Service] = service => Json.obj(service.name.value := service.container)
