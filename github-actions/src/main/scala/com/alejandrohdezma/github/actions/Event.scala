...
object Event extends Enum[Event] with CatsEnum[Event] {
  ...
  object CheckRun {
    ...
    lazy val Created         = Types.Created
    lazy val Rerequested     = Types.Rerequested
    lazy val Completed       = Types.Completed
    lazy val RequestedAction = Types.RequestedAction
  ...
  object CheckSuite {
    ...
    lazy val Completed   = Types.Completed
    lazy val Requested   = Types.Requested
    lazy val Rerequested = Types.Rerequested
  ...
  object IssueComment {
    ...
    lazy val Created = Types.Created
    lazy val Edited  = Types.Edited
    lazy val Deleted = Types.Deleted
  ...
  object Issues {
    ...
    lazy val Opened       = Types.Opened
    lazy val Edited       = Types.Edited
    lazy val Deleted      = Types.Deleted
    lazy val Transferred  = Types.Transferred
    lazy val Pinned       = Types.Pinned
    lazy val Unpinned     = Types.Unpinned
    lazy val Closed       = Types.Closed
    lazy val Reopened     = Types.Reopened
    lazy val Assigned     = Types.Assigned
    lazy val Unassigned   = Types.Unassigned
    lazy val Labeled      = Types.Labeled
    lazy val Unlabeled    = Types.Unlabeled
    lazy val Locked       = Types.Locked
    lazy val Unlocked     = Types.Unlocked
    lazy val Milestoned   = Types.Milestoned
    lazy val Demilestoned = Types.Demilestoned
  ...
  object Project {
    ...
    lazy val Created  = Types.Created
    lazy val Updated  = Types.Updated
    lazy val Closed   = Types.Closed
    lazy val Reopened = Types.Reopened
    lazy val Edited   = Types.Edited
    lazy val Deleted  = Types.Deleted
  ...
  object ProjectCard {
    ...
    lazy val Created   = Types.Created
    lazy val Moved     = Types.Moved
    lazy val Converted = Types.Converted
    lazy val Edited    = Types.Edited
    lazy val Deleted   = Types.Deleted
  ...
  object PullRequest {
    ...
    lazy val Closed               = Types.Closed
    lazy val Reopened             = Types.Reopened
    lazy val Synchronize          = Types.Synchronize
    lazy val ReadyForReview       = Types.ReadyForReview
    lazy val Locked               = Types.Locked
    lazy val Unlocked             = Types.Unlocked
    lazy val ReviewRequested      = Types.ReviewRequested
    lazy val ReviewRequestRemoved = Types.ReviewRequestRemoved
  ...
  object PullRequestReview {
    ...
    lazy val Submitted = Types.Submitted
    lazy val Edited    = Types.Edited
    lazy val Dismissed = Types.Dismissed
  ...
  object RegistryPackage {
    ...
    lazy val Published = Types.Published
    lazy val Updated   = Types.Updated
  ...
  object Release {
    ...
    lazy val Published   = Types.Published
    lazy val Unpublished = Types.Unpublished
    lazy val Created     = Types.Created
    lazy val Edited      = Types.Edited
    lazy val Deleted     = Types.Deleted
    lazy val Prereleased = Types.Prereleased
    lazy val Released    = Types.Released
   ...
   */
  final case class RepositoryDispatch(types: Option[NonEmptyList[NonEmptyString]] = None)
      extends Event(Json.obj("types" := types))
   ...
   */
  final case class Schedule(crons: NonEmptyList[String Refined Cron])
      extends Event(crons.map(cron => Json.obj("cron" := cron)).asJson)
