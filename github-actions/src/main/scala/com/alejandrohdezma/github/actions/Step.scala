...
sealed abstract class Step(
    ...
    val `if`: Option[String],
    val name: Option[String],
    val env: Map[String, String],
    val continueOnError: Either[Boolean, Expression],
...
object Step {
   ...
   */
  final case class Uses(action: String, `with`: (String, String)*)(
      override val id: Option[String] = None,
      override val `if`: Option[String] = None,
      override val name: Option[String] = None,
      override val env: Map[String, String] = Map(),
      override val continueOnError: Either[Boolean, Expression] = Left(false),
