...
object Runner {
  ...
  object HostedRunner {
    ...
    case object `macos-10.15`    extends HostedRunner(NotEmptyString.unsafe("macos-10.15"))
    case object `macos-11.0`     extends HostedRunner(NotEmptyString.unsafe("macos-11.0"))
    case object `macos-latest`   extends HostedRunner(NotEmptyString.unsafe("macos-latest"))
    case object `self-hosted`    extends HostedRunner(NotEmptyString.unsafe("self-hosted"))
    case object `ubuntu-16.04`   extends HostedRunner(NotEmptyString.unsafe("ubuntu-16.04"))
    case object `ubuntu-18.04`   extends HostedRunner(NotEmptyString.unsafe("ubuntu-18.04"))
    case object `ubuntu-20.04`   extends HostedRunner(NotEmptyString.unsafe("ubuntu-20.04"))
    case object `ubuntu-latest`  extends HostedRunner(NotEmptyString.unsafe("ubuntu-latest"))
    case object `windows-2016`   extends HostedRunner(NotEmptyString.unsafe("windows-2016"))
    case object `windows-2019`   extends HostedRunner(NotEmptyString.unsafe("windows-2019"))
    case object `windows-latest` extends HostedRunner(NotEmptyString.unsafe("windows-latest"))
