...
lazy val `github-actions` = project
  ...
  .settings(libraryDependencies += "org.typelevel" %% "cats-core" % "2.5.0")
  .settings(libraryDependencies += "eu.timepit" %% "refined" % "0.9.22")
  .settings(libraryDependencies += "eu.timepit" %% "refined-cats" % "0.9.22")
